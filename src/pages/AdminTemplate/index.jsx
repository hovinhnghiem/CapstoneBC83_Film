      ...
      >
        <div className="h-full px-3 py-4 overflow-y-auto bg-[#202a37] ">
          ...
          <ul className="space-y-2 font-medium">
            ...
            <li>
              <Link to="/admin/movies-theater" className="flex items-center p-2 text-white hover:text-red-500  rounded-lg">
          ...
          {showMenu && (
            <div className="absolute right-0 mt-2 w-48 bg-white border rounded shadow-lg z-50">
              <button
                ...
                className="block px-4 py-2 w-full text-left hover:bg-blue-200"
              >
                Cập nhật thông tin
              </button>
              <button
                onClick={handleLogout}
                className="block px-4 py-2 w-full text-left text-red-600 hover:bg-blue-200"
              >
                Đăng xuất
              </button>
            </div>
